# based on: https://github.com/TsinghuaDatabaseGroup/CrowdTI/blob/master/truth_inference_crowd/truth_methods/c_EM/method.py (17.11.2020)
import math
import csv
import random
import sys
...
class EM:
    def __init__(self,e2wl,w2el,label_set,e2t, initquality):
        self.e2wl = e2wl
        self.w2el = w2el
